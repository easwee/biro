...
export const ownerData = writable({
  company_name: "EXAMPLE.NET, John Doe s.p., coding services",
  company_address: "Fake street 12",
  company_postal_number: "1000",
  company_city: "Faketown",
  company_tax_registration_number: "123123123",
  ...
  terms: 20,
  vat: 0,
  pdf_file_name_prefix: "example-company-invoice"
});

export const clientData = writable({
  client_company_name: "Povio Inc.",
  client_company_address: '"16 Merced Avenue 94127 California"',
  client_company_city: "San Francisco",
  client_company_zip: "CA 94127 ",
